...
constexpr std::string_view kC3ToolVersion = "0.9.0-variable-record-cli-slice";
#elif defined(PAE_ENABLE_PROTOCOL_LAB_SCHEMA_V07_LENGTH)
...
#endif
#if defined(PAE_ENABLE_PROTOCOL_LAB_SCHEMA_V08_VARIABLE)
         std::filesystem::is_regular_file(bundle / "run_record_v0.10.json") ||
#endif
