...
既有 [0.11 非 Qt 验证](../../engineering/lab-public-ascii-stream-validation.md) 记录 static D/R consumer 的
...
Lab 可独立构建证据。该候选的 [SDK 验证报告](../../engineering/pae-public-stream-sdk-validation.md) 仍记录生成时
