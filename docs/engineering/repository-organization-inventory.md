...
本文落实[公开执行、独立交付与仓库整理推进计划](pae-execution-delivery-organization-plan.md)的阶段 0 仓库盘点，只给出后续可执行边界，不表示目录迁移、SDK 打包或清理已经完成。现场为 `main@dfb08f351cdb22a9b50c9e64e688e3b666e669bc`，暂存区为空；既有 docs 迁移、Host/UI 和 public API 未提交变更全部保留。
