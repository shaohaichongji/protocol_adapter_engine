...
| Qt Lab | ASCII 0.10/0.11；Binary UI 当前为 0.9 完整记录 Decode | Binary Encode/stream 已进入 UI |
...
当前本机候选来自 clean-checkpoint `98df5e0d844413fb6ad16a75dfceedcf17f2f1d6`，已有指定 Windows x64、MSVC v142 14.29.30133、Static/Shared Debug/Release 的限定验证。它仍然是本地候选：
