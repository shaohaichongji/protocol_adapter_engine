...
当前推荐 SDK 五包来自 clean `7b4205ea899cf16b9c73ba6ebc4c64382b71dc63`，已完成指定 Windows x64、MSVC v142 14.29.30133 的 Source/Static/Shared Debug/Release 包外消费验证。首选 Lab 来自 `fe1683c` 加结构化诊断与 Binary 流式示例打包的未提交修补，并消费该 installed SDK；两者仍须分别记录身份和验证，见 [交付入口](../../deliverables/README.md)。SDK 与 Lab 都只是本地候选：
