...
| Qt Lab | Binary 完整 Decode/Encode、G2 流式观察、ASCII 0.10/0.11 路径、结构化编译诊断及中文工作台 | 所有构建都启用相同能力；短体验或定向测试可替代正式发布验收 |
...
当前推荐 SDK 五包来自 clean `7b4205ea899cf16b9c73ba6ebc4c64382b71dc63`，已完成指定 Windows x64、MSVC v142 14.29.30133 的 Source/Static/Shared Debug/Release 包外消费验证。首选 Lab 来自 `fe1683c` 加构建时尚未提交的结构化诊断与 Binary 流式示例打包修补，并消费该 installed SDK；修补现已提交，但旧二进制未重建。两者仍须分别记录身份和验证，见 [交付入口](../../deliverables/README.md)。SDK 与 Lab 都只是本地候选：
